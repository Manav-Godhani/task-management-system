...
export default function Mediumpriority() {
    ...
    const updateStatus = async (id, currentStatus) => {
        ...
        if (allowedStatuses.includes(currentStatus)) {
            const confirmUpdate = window.confirm("Are you sure you want to update status?");
    ...
    return (
        <div className="d-flex">
            ...
            <div className="content bg-black">
                <h2 className="title text-secondary">Medium Priority Tasks</h2>
                <div className="task-grid">
                    {tasks
                        .filter(task => task.priority.toLowerCase() === "medium priority")
                        .map(task => (
