...
export default function Userdeployed() {
  ...
  useEffect(() => {
    const fetchTasks = async () => {
      try {
        ...
        const deployedTasks = response.data.data.filter(task => task.taskstatus.toLowerCase() === "deployed");
  ...
  return (
    <div className="d-flex">
      ...
      <div className="content bg-black">
        <h2 className="title text-secondary">Deployed Tasks</h2>
